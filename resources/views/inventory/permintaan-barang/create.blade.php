                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  @error('kode_item') is-invalid @enderror"
                                id="kode_item" name="kode_item" value="{{ old('kode_item') }}" placeholder="Kode Item"
                                required>
                            @error('kode_item')
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  @error('nama_item') is-invalid @enderror"
                                id="nama_item" name="nama_item" value="{{ old('nama_item') }}" placeholder="Nama Item"
                                required>
                            @error('nama_item')
                                <div class="form-text text-danger">
                                    {{ $message }}
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  @error('no_pp_manual') is-invalid @enderror"
                                id="no_pp_manual" name="no_pp_manual" value="{{ old('no_pp_manual') }}"
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('no_pr') is-invalid @enderror"
                                id="no_pr" name="no_pr" value="{{ old('no_pr') }}" placeholder="No. PR">
                            @error('no_pr')
                                <div class="form-text text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" max="99999"
                                ...
                                name="kuantitas" value="{{ old('kuantitas') }}" placeholder="Kuantitas" required>
                            @error('kuantitas')
                                <div class="form-text text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('uom') is-invalid @enderror" id="uom"
                                name="uom" value="{{ old('uom') }}" placeholder="Satuan (UoM)">
                            @error('uom')
                                <div class="form-text text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="estimasi_harga" name="estimasi_harga"
                                    ...
                                    placeholder="Estimasi Harga" value="{{ old('estimasi_harga') }}" maxlength="13"
                                    required>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('keterangan_alokasi') is-invalid @enderror" id="keterangan_alokasi"
                                name="keterangan_alokasi" rows="4" placeholder="Keterangan Alokasi">{{ old('keterangan_alokasi') }}</textarea>
